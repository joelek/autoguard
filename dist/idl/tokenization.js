...
exports.Families = ((...tuple) => tuple)("LS", "WS", "(", ")", "[", "]", "{", "}", "?", "|", ".", "..", "/", "*", "&", ",", ":", ";", "<", ">", "_", "~", "-", "=>", "<=", "any", "bigint", "binary", "boolean", "date", "false", "guard", "integer", "null", "number", "plain", "route", "string", "table", "true", "undefined", "IDENTIFIER", "NUMBER_LITERAL", "STRING_LITERAL", "PERCENT_ENCODED_OCTET", "COMMENT");
exports.IdentifierFamilies = ((...tuple) => tuple)("any", "bigint", "binary", "boolean", "date", "false", "guard", "integer", "null", "number", "plain", "route", "string", "table", "true", "undefined", "IDENTIFIER");
